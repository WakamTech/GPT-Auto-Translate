...
1. Page de Réglages du Plugin (Clé API, Modèle, Langues, Types de Contenu).
2. Meta Box de Traduction dans l'Éditeur de Publication (montrant le statut et le bouton de traduction).
3. Exemple de vue d'un contenu traduit (optionnel).
4. Exemple montrant l'intégration avec la boîte de langues Polylang (optionnel).
